...
inline fun <reified T : Any> StoreTransaction.find(property: KxVariable<*, *>, value: Any) = find(T::class, property, value)
fun <T : Any> StoreTransaction.find(type: KClass<T>, property: KxVariable<*, *>, value: Any) = find(
        type.xodusName,
        property.name,
        XodusConversion.toXodus(value, property.type)
)

inline fun <reified T : Any> StoreTransaction.find(property: KxVariable<*, *>, from: Any, to: Any) = find(T::class, property, from, to)
fun <T : Any> StoreTransaction.find(type: KClass<T>, property: KxVariable<*, *>, from: Any, to: Any) = find(
        type.xodusName,
        property.name,
        XodusConversion.toXodus(from, property.type),
        XodusConversion.toXodus(to, property.type)
)
